...
export default function ManageExercises() {
    ...
    var _a = useQuery({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, apiRequest("GET", "/api/admin/exercises").then(function (res) { return res.json(); })];
        }); }); },
        initialData: [],
    }), exercises = _a.data, isLoading = _a.isLoading;
    var mutation = useMutation({
        mutationFn: function (newExercise) { return apiRequest("POST", "/api/exercises", newExercise); },
        onSuccess: function () {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2">
          <Card>
            ...
            <CardContent>
              {isLoading ? (<p>Loading exercises...</p>) : (<div className="space-y-2">
                  {exercises === null || exercises === void 0 ? void 0 : exercises.map(function (exercise) { return (<div key={exercise.id} className="border p-4 rounded-lg">
