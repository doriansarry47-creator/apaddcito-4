...
export var intensities = {
    gentle: 'Douce',
    moderate: 'Modérée',
    dynamic: 'Dynamique'
};
export function getExercisesByCategory(category) {
    return exercises.filter(function (exercise) { return exercise.category === category; });
}
export function getExercisesByLevel(level) {
    return exercises.filter(function (exercise) { return exercise.level === level; });
}
export function getEmergencyExercises() {
    return exercises.filter(function (exercise) { return exercise.type === 'emergency'; });
}
export function getExerciseById(id) {
    return exercises.find(function (exercise) { return exercise.id === id; });
}
